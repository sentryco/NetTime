import Foundation
/**
 * - Abstract: TimeMeasure is a utility class for measuring the execution time of code blocks.
 * - Description: It provides static methods to measure the time taken for synchronous operations
...
internal final class TimeMeasure {
    ...
    * - Description: This typealias defines a closure type named Operation
    *                that takes no parameters and throws an error if it fails.
    *                It is used in the timeElapsed methods to measure the
    *                execution time of a given operation.
    */
   internal typealias Operation = () throws -> Void
   /**
    * Measures how long a closure takes to complete
    * - Description: This method measures the execution time of a given closure
    *                in seconds. It takes a closure as a parameter, executes it,
    *                and returns the time taken for the closure to complete its
    *                execution.
    ...
    * - Description: This method measures the execution time of a given closure
    *                and returns the result of the closure along with the time
    *                taken. It is useful for performance testing and optimization
    *                by allowing developers to quantify the duration of code
    *                execution.
